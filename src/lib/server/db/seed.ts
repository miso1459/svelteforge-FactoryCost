	...
	const menuData = [
		{
			...
			name: "Master",
			desc: "Master data management for items, BOM, and product definitions",
			path: null,
			icon: null,
			role: '["admin","editor"]',
			sortOrder: 0,
		...
		},
		{
			...
			type: "folder" as const,
			name: "Inventory",
			desc: "Inventory transactions, stock levels, and production results",
			path: null,
			icon: "folder-tree",
			role: '["admin","editor"]',
			sortOrder: 1,
		...
		},
		{
			...
			desc: "Record inventory movements: receipts, issues, adjustments, transfers",
		...
		},
		{
			...
			desc: "View current stock levels, quantities, and inventory valuation",
